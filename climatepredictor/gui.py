...
make_value_entry(advanced_frame,'Albedo',0,0,albedo_initial,albedo_rate,'')
make_value_entry(advanced_frame,u'\u03B5\u2081',1,0,epsilon1_initial,epsilon1_rate,'')
make_value_entry(advanced_frame,u'\u03B5\u2082',2,0,epsilon2_initial,epsilon2_rate,'')
solar_label=ttk.Label(advanced_frame,text=u'S\u2080/present day solar flux')
solar_label.grid(column=0,row=3, sticky=(N, W, E, S))
solar_flux=float()
solar_entry=ttk.Entry(advanced_frame,textvariable=solar_flux)
solar_entry.grid(column=1,row=3, sticky=(N, W, E, S))
